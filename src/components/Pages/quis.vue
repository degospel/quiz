    ...
    data (){
        return{
            questions:[
                ...
                {
                    question: "What the correct syntax for reffering to an external script called 'xxx.js' ?",
                    suggestions:[
                        {suggestion:'<script herf="xxx.js">',},
...
<style scoped>
    .tre{
        background:linear-gradient(#0000, #000), url("~@/assets/code1.jpg");
        height:100vh;
        width: 100%;
